...
class QrScanRoundTrees extends StatefulWidget {
  late String id;
  QrScanRoundTrees(this.id);
  @override
  _QrScanRoundTreesState createState() => _QrScanRoundTreesState();
}

class _QrScanRoundTreesState extends State<QrScanRoundTrees> {
  late String id;
  late int reqNum;
